...
CKEDITOR.dialog.add( 'droplets', function( editor ) {
	...
	return {
		title: editor.lang.droplets.droplets.title,
		minWidth: 300,
		minHeight: 60,
		onOk: function() {
		...
		contents: [
			{
			id: 'info',
			label: editor.lang.droplets.droplets.title,
			accessKey: 'I',
			elements: [
			{
				type: 'select',
				...
				label: editor.lang.droplets.droplets.name,
				required: true,
				onChange:function(){
					var e=editor.lang.droplets,
						...
						
			{
				type: 'text',
				id: 'droplet-edit',
				label: editor.lang.droplets.editDroplet,
				required: true,
				onLoad: function() {
				...
				validate: function() {
					var func = CKEDITOR.dialog.validate.notEmpty( editor.lang.droplets.noUrl );
